        ...
        <View style={styles.cartSection}>
          <View style={styles.cartBlock}>
            ...
            <View style={styles.cartItem}>
              <Text style={styles.head}>DISCLAMER</Text>
              <Text style={styles.para}>
                PYAAS does not manufacture any goods. PYAAS is only an E-commerce service provider for supply / delivery of water jars on behalf of the respective brand / manufactures and PYAAS source/buy all its products from the brands or their authorized partners directly. PYAAS does not hold any responsibility or liability of product quality, specifications and other related parameters. Customers are advised to check all details and select the brand / product they wish to order. 
              </Text>
            </View>           
